...
<div class="x_panel">
    ...
    <div class="x_content">
        <form action="edit_multiple_restock_kaos_kaki.html" method="POST">
...
<script>
    function detail(barang_detail_id) {
        axios.post('inc/restock/restock_kaos_kaki/aksi_detail_restock.php', {
    ...
    function simpan() {
        ...
        axios.post('inc/restock/restock_kaos_kaki/aksi_simpan_restock.php', {
            'barang_detail_id': barang_detail_id,
    ...
    function edit(barang_detail_id) {
        axios.post('inc/restock/restock_kaos_kaki/aksi_edit_restock.php', {
            'barang_detail_id': barang_detail_id
        }).then(function(res) {
            var edit = res.data
            console.log(edit);
