...
if (isset($_POST['update'])) {
    ...
    echo "
    <script>
    window.location='restock_barang_lainnya.html';
    </script>
    ";
    exit;
}
                ...
                <div class="row" style="font-size:12px">
                    <div class="col-md-9">
                        <div class="form-group">
                            <label>Artikel</label>
                            <input type="text" value="<?php echo $data['barang_artikel'] . " - " . $data['barang_detail_barcode'] . " - " . $data['barang_nama'] . " - " . "(" . $data['barang_lainnya_nama_ukuran'] . ")" ?>" required="required" placeholder="Nama Artikel" class="form-control" readonly>
