                ...
                <div class="row" style="font-size:12px">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Artikel</label>
                            <input type="text" value="<?php echo $data['barang_kode'] . " - " . $data['barang_nama'] . " - " . "(" . $data['barang_lainnya_nama_ukuran'] . ")" ?>" required="required" placeholder="Nama Artikel" class="form-control" readonly>
