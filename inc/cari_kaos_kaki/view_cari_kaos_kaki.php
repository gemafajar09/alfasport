    ...
    <div class="x_content table-responsive">
        <div class="col-sm-6 col-md-6 col-lg-6">
            <div class="form-group">
                <label>Artikel Kaos Kaki</label>
                <select name="artikel" id="artikel" class="form-control select2">
                    <option value="">-Artikel Kaos Kaki-</option>
                    <?php
                    $artikel = $con->select('tb_gudang_kaos_kaki', '*');
                    foreach ($artikel as $a) {
                    ?>
                        <option value="<?= $a['gudang_kaos_kaki_id'] ?>"><?= $a['gudang_kaos_kaki_nama'] ?> - <?= $a['gudang_kaos_kaki_artikel'] ?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
...
<script>
    $('#toko').change(function(e) {
        ...
        axios.post('inc/cari_kaos_kaki/filter/toko.php', {
            'toko': toko,
            'artikel': artikel
        }).then(function(res) {
            ...
            if (data.detail != false) {
                ...
                $('#namaartikel').text(data.detail.gudang_kaos_kaki_artikel);
                $('#namabarang').text(data.detail.gudang_kaos_kaki_nama);
                $('#modal').text(data.detail.gudang_kaos_kaki_modal);
                $('#jual').text(data.detail.gudang_kaos_kaki_jual);
