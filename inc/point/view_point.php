...
<!-- The Modal -->
<!-- <div class="modal" id="dataPoint">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Data Point</h4>
            </div>
...
<script>
    ...
    //     axios.post('inc/point/aksi_simpan_point.php', {
    ...
    //         var simpan = res.data
    //         console.log(simpan)
    //         $('#dataPoint').modal('hide')
    //         $('#isi').load('inc/point/data_point.php');
    //         kosong()
    //     }).catch(function(err) {
    //         alert(err)
    //         $('#dataPoint').modal('hide')
    ...
    // function edit(id) {
    //     axios.post('inc/point/aksi_edit_point.php', {
    //         'divisi_id': id
    //     }).then(function(res) {
    //         var edit = res.data
    ...
    // function hapus(id) {
    //     axios.post('inc/point/aksi_hapus_point.php', {
    //         'divisi_id': id
    //     }).then(function(res) {
    //         var hapus = res.data
    //         $('#isi').load('inc/point/data_point.php');
