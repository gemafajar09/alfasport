...
$data = $con->query("SELECT
                            ...
                            tb_merk On tb_barang.merk_id = tb_merk.merk_id Inner Join
                            tb_kategori On tb_barang.kategori_id = tb_kategori.kategori_id Inner Join
                            tb_divisi On tb_barang.divisi_id = tb_divisi.divisi_id Inner Join
                            tb_subdivisi On tb_barang.subdivisi_id = tb_subdivisi.subdivisi_id Inner Join
                            tb_gender On tb_barang.gender_id = tb_gender.gender_id Inner Join
