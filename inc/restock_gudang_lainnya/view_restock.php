<div class="page-title">
    <div class="title_left">
        <h3>Restock Barang Gudang Lainnya</h3>
    </div>
...
<div class="x_panel">
    ...
    <div class="x_content">
        <form action="editMultipleRestockLainnya.html" method="POST">
...
<script>
    function detail(gudang_lainnya_detail_id) {
        axios.post('inc/restock_gudang_lainnya/aksi_detail_restock.php', {
    ...
    function simpan() {
        var gudang_lainnya_detail_id = $('#id_detail').val()
        var gudang_lainnya_kode = $('#id_artikel').val()
        var gudang_lainnya_artikel = $('#artikel').val()
        var jumlah_restock = $('#jumlah_restock').val()
        var gudang_lainnya_detail_jumlah = $('#jumlah').val()
        axios.post('inc/restock_gudang_lainnya/aksi_simpan_restock.php', {
            'gudang_lainnya_detail_id': gudang_lainnya_detail_id,
            ...
            $('#isi').load('inc/restock_gudang_lainnya/data_restock.php');
        }).catch(function(err) {
            console.log(err)
    ...
    function edit(gudang_lainnya_detail_id) {
        axios.post('inc/restock_gudang_lainnya/aksi_edit_restock.php', {
            'gudang_lainnya_detail_id': gudang_lainnya_detail_id
        }).then(function(res) {
            var edit = res.data
            $('#id_artikel').val(edit.gudang_lainnya_kode);
            $('#artikel').val(edit.gudang_lainnya_nama + " - " + edit.gudang_lainnya_artikel + " - " + edit.gudang_lainnya_detail_barcode)
            $('#id_detail').val(edit.gudang_lainnya_detail_id)
            $('#jumlah').val(edit.gudang_lainnya_detail_jumlah)
    ...
    function cekeditSekaligus() {
        var ceklist = document.getElementsByName("gudang_lainnya_detail_id[]");
