...
$data = $con->query("SELECT a.*, b.* 
                    ...
                    WHERE a.voucher_tgl_mulai > '$tgl_sekarang'
                    AND a.voucher_tgl_akhir > '$tgl_sekarang'
                    ")->fetchAll();
foreach ($data as $i => $a) {
?>
    <tr>
        ...
        <td>
            ...
            <button type="button" id="hapus" onclick="hapus('<?= $a['voucher_id'] ?>')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
        </td>
    </tr>
<?php } ?>