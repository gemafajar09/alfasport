...
$kode = $con->query("SELECT
                    ...
                    WHERE tb_voucher_detail.voucher_id = '$_POST[voucher_id]'")->fetchAll();
...
<script>
    function cekMenipis(voucher_detail_id, stok_checked) {
        if (stok_checked.checked) {
            axios.post('inc/diskon/voucher/aksi_update_status_dipakai.php', {
            ...
            axios.post('inc/diskon/voucher/aksi_update_status_belum_dipakai.php', {
                'voucher_detail_id': voucher_detail_id
            }).then(function(res) {
                var data = res.data
