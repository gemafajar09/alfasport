            ...
            <form action="aksiLogin.html" method="POST">
              <h1>Register</h1>
                <div class="field item form-group">
                    <input class="form-control" data-validate-length-range="5" name="nama" placeholder="Nama" required="required" />
                </div>
                <div class="field item form-group">
                    <input class="form-control" data-validate-length-range="5" name="username" placeholder="Username" required="required" />
                </div>
                <div>
                    <input type="password" name="password1" class="form-control" data-validate-length-range="5" placeholder="Password" required="required" />
                </div>
                <div>
                    <input type="password" name="password2" class="form-control" data-validate-length-range="5" placeholder="Ulangi Password" required="required" />
                </div>
                <div>
                    <select name="level" class="form-control" required="required" id="">
